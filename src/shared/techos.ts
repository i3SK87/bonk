/**
 * El techo de gasto de una categoría, en limpio y sin base de datos delante.
 *
...
/**
 * Lo gastado sobre el techo, en tanto por ciento. Puede pasar de cien: un mes
 ...
 * techo al -12 %, es un techo sin tocar.
 */
export function porcentajeDeTecho(gastado: number, techo: number): number {
  if (techo <= 0) return 0
  return Math.round((Math.max(0, gastado) / techo) * 100)
}
 ...
 * vez, y no se vuelve a decir nada hasta cruzar el techo entero.
 */
